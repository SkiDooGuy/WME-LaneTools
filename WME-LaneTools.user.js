...
(function main() {
  ...
  const LANETOOLS_VERSION = "" + GM_info.script.version,
    ...
    TRANSLATIONS = {
      default: {
        ...
        enClick: getString(0x470),
        clickStraight: "All\x20straight\x20lanes",
        clickTurn: getString(0x40c),
  ...
  function laneToolsBootstrap(bootStrapAttempt = 0x0) {
    if (
      window["W"] &&
      window["W"][getString(0x423)] &&
      window["W"][getString(0x240)] &&
      W.loginManager[getString(0x2d4)] &&
      $ &&
      WazeWrap[getString(0x45b)]
    )
      initLaneTools();
    else
  ...
  async function setupOptions() {
    function _0x1bd25b() {
      _0x26700c("lt-ScriptEnabled", LtSettings["ScriptEnabled"]),
        ...
        _0x26700c(getString(0x34b), LtSettings[getString(0x469)]),
        _0x26700c(getString(0x1fa), LtSettings[getString(0x396)]),
        _0x26700c(getString(0x1ec), LtSettings["CSEnable"]),
        _0x26700c(getString(0x380), LtSettings["highlightOverride"]),
        _0x26700c(getString(0x262), LtSettings[getString(0x1fd)]),
        _0x26700c(getString(0x243), LtSettings[getString(0x2c0)]),
        _0x26700c(getString(0x378), LtSettings["serverSelect"]),
        _0x26700c(getString(0x327), LtSettings[getString(0x23f)]),
        _0x26700c("lt-ReverseLanesIcon", LtSettings[getString(0x45e)]),
        _0x26700c(getString(0x211), LtSettings[getString(0x475)]),
        _0x26700c(getString(0x36b), LtSettings["ClickSaveStraight"]),
        _0x26700c(getString(0x2f4), LtSettings[getString(0x409)]),
        _0x26700c(getString(0x341), LtSettings[getString(0x459)]),
        _0x26700c("lt-LaneHeurNegHighlight", LtSettings[getString(0x449)]),
        _0x26700c(getString(0x3c4), LtSettings[getString(0x1f1)]),
        _0x26700c(getString(0x43b), LtSettings[getString(0x479)]),
        _0x26700c(getString(0x245), LtSettings[getString(0x3e0)]),
        _0x26700c(getString(0x3b3), LtSettings[getString(0x38f)]),
        _0x26700c(getString(0x427), LtSettings[getString(0x42a)]),
        _0x1871fd("lt-ABColor", LtSettings[getString(0x20c)]),
        _0x1871fd(getString(0x212), LtSettings[getString(0x344)]),
        _0x1871fd("lt-LabelColor", LtSettings[getString(0x233)]),
        _0x1871fd(getString(0x44d), LtSettings[getString(0x472)]),
        _0x1871fd(getString(0x3fa), LtSettings[getString(0x430)]),
        _0x1871fd(getString(0x2d3), LtSettings[getString(0x33f)]),
        _0x1871fd(getString(0x2a7), LtSettings["LIOColor"]),
        _0x1871fd(getString(0x20a), LtSettings["CS1Color"]),
  ...
  async function loadSpreadsheet() {
    const _0x1cac32 = getString;
    let _0x4d1b99 = ![];
    const _0x19ae0f = "AIzaSyDZjmkSx5xWc-86hsAIzedgDgRgy8vB7BQ",
      _0x2a0637 = (_0x135a7d, _0x3e3ad5, _0x5d931b) => {
        const _0x48f1b9 = getString;
        console["error"](_0x48f1b9(0x364), _0x5d931b);
      },
      _0x283eac = (_0x2d5151, _0x4e197b, _0x4cc7f4) => {
        const _0x30559d = getString;
        console[_0x30559d(0x32b)](_0x30559d(0x44c), _0x4cc7f4),
          !RBSArray[_0x30559d(0x40a)] &&
            (WazeWrap[_0x30559d(0x46a)][_0x30559d(0x32b)](
              GM_info["script"][_0x30559d(0x412)],
              _0x30559d(0x1f3)
            ),
            (RBSArray[_0x30559d(0x40a)] = !![]));
      },
    ...
    try {
      await $["getJSON"](_0x1cac32(0x2e3) + _0x19ae0f)
        ["done"](async (_0xa6fa70) => {
          const _0x5e17fb = _0x1cac32;
          _0xa6fa70[_0x5e17fb(0x24d)][_0x5e17fb(0x408)] > 0x0
            ? _[_0x5e17fb(0x3e2)](_0xa6fa70[_0x5e17fb(0x24d)], (_0x1f6053) => {
                const _0x5ab21b = _0x5e17fb;
    ...
    try {
      await $[_0x1cac32(0x28d)](_0x1cac32(0x3cb) + _0x19ae0f)
        [_0x1cac32(0x47a)]((_0x27c1b9) => {
          const _0x5c0b99 = _0x1cac32;
  ...
  function lt_segment_length(_0x59d9ca) {
    const _0x2a0c3c = getString;
    let _0x1c8c74 = _0x59d9ca[_0x2a0c3c(0x28f)][_0x2a0c3c(0x303)](
      window["W"]["map"]["olMap"][_0x2a0c3c(0x208)]
    );
    return (
      lt_log(
        _0x2a0c3c(0x258) +
          _0x59d9ca[_0x2a0c3c(0x395)]["id"] +
          _0x2a0c3c(0x3c9) +
          _0x1c8c74 +
          _0x2a0c3c(0x25c) +
          _0x59d9ca[_0x2a0c3c(0x395)][_0x2a0c3c(0x408)],
        0x3
      ),
      _0x1c8c74
    );
