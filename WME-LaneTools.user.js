...
(function main() {
    ...
    function laneToolsBootstrap(bootStrapAttempt = 0x0) {
        if (W && W.map && W.model && W.loginManager.user && $ && WazeWrap.Ready)
            ...
            bootStrapAttempt < 500 ? setTimeout(() => {
    ...
    async function setupOptions() {
        ...
        if (_pickleColor > 0x1) {
            ...
            if (allowCpyPst) {
                ...
                sheetLinkSelector.on("mouseenter", function () {
    ...
    function lanesTabSetup() {
        ...
        if (getId("lt-UIEnable").checked && getId("lt-ScriptEnabled").checked && selectedFeatures.length > 0x0) {
            if (selectedFeatures.length === 0x1 &&
                ...
                getId("lt-AutoLanesTab").checked && setTimeout(() => {
    ...
    function getLanesConfig(segment, node, attachedSegments, laneCount) {
        let _0x739f97 = false, _0x55ea18 = false, _0x16f110 = false, _0x161259 = false, _0x5c5507 = 0x0,
            _0x4211dc = null,
            _0x44a7d8 = [];
    ...
    function _0x5694f9(_0x3399d1) {
        ...
        for (let idx = 0x0; idx < _0x3399d1.length; idx++) {
            ...
            (uturnObject.svg = $(_0x3399d1[idx]).find("svg").map(function () {
                return this;
            }).get());
        ...
        if (UPDATEDZOOM) {
            if (_0x23f39e === 0x0)
                ...
                if (_0x23f39e === 0x1)
                    ...
                    if (_0x23f39e === 0x2)
                        temp = {
                            x: nodeObj.geometry.x - (laneDisplayBoxConfiguration.start + laneDisplayBoxConfiguration.boxincwidth * _0x5095aa),
                        ...
                        if (_0x23f39e === 0x3)
                            ...
                            if (_0x23f39e === 0x4)
                                temp = {
                                    x: nodeObj.geometry.x - (laneDisplayBoxConfiguration.start + laneDisplayBoxConfiguration.boxheight * 1.5),
                                    y: nodeObj.geometry.y - (laneDisplayBoxConfiguration.start + laneDisplayBoxConfiguration.boxincwidth * _0x5095aa * 1.5),
                                };
                            else {
                                if (_0x23f39e === 0x5)
                                    temp = {
                                        x: nodeObj.geometry.x + (laneDisplayBoxConfiguration.start + laneDisplayBoxConfiguration.boxincwidth / 0x2),
                                    ...
                                    if (_0x23f39e === 0x6)
                                        temp = {
                                            ...
                                            y: nodeObj.geometry.y - laneDisplayBoxConfiguration.start * ((laneDisplayBoxConfiguration.boxincwidth * _0x5095aa) / 0x2),
                                        };
                                    else
                                        _0x23f39e === 0x7 && (temp = {
                                            x: nodeObj.geometry.x - laneDisplayBoxConfiguration.start * ((laneDisplayBoxConfiguration.boxincwidth * _0x5095aa) / 0x2),
                ...
                if (_0x23f39e === 0x1)
                    ...
                    if (_0x23f39e === 0x2)
                        ...
                        if (_0x23f39e === 0x3)
                            temp = {
                                x: nodeObj.geometry.x + (laneDisplayBoxConfiguration.start + laneDisplayBoxConfiguration.boxincwidth),
                                y: nodeObj.geometry.y - (laneDisplayBoxConfiguration.start + laneDisplayBoxConfiguration.boxheight * 0x2),
                            };
                        else {
                            if (_0x23f39e === 0x4)
                                temp = {
    ...
    function _0x19644c(nodeObj, segmentObject, _0x533989) {
        let laneDisplayBoxConfiguration = getLaneDisplayBoxObjectConfig(),
            cardinalAngle = getCardinalAngle(nodeObj.attributes.id, segmentObject), centroid,
        ...
        var topLeftVtx = new OpenLayers.Geometry.Point(_0x2a17ea.x, _0x2a17ea.y + laneDisplayBoxConfiguration.boxheight),
            ...
            bottomRightVtx = new OpenLayers.Geometry.Point(_0x2a17ea.x + laneDisplayBoxConfiguration.boxincwidth * _0x5095aa, _0x2a17ea.y),
    ...
    function displayLaneGraphics() {
        ...
        let _0x2d2a03 = wmeObject.attributes.fwdLaneCount > 0x0
                ? _0x5694f9($(".fwd-lanes").find(".lane-arrow").map(function () {
                    return this;
                }).get())
                : false,
            _0x154122 = wmeObject.attributes.revLaneCount > 0x0
                ? _0x5694f9($(".rev-lanes").find(".lane-arrow").map(function () {
                    return this;
                }).get())
                : false;
