  ...
  async function setupOptions() {
    ...
    try {
      ...
      console.log("LT\x20Error\x20creating\x20shortcuts.\x20This\x20feature\x20will\x20be\x20disabled."),
          ...
          $("#lt-LaneHeurChecksShortcut").text("" + TRANSLATIONS.default.disabled), (shortcutsDisabled = true);
    }
      ...
      if (UPDATEDZOOM)
        ...
        case 21:
          (boxDisplayObject.start = 0x1); (boxDisplayObject.boxheight = 3.2); (boxDisplayObject.boxincwidth = 2.2);
              (boxDisplayObject.iconbordermargin = 0.2); (boxDisplayObject.iconborderheight = 3);
              (boxDisplayObject.iconborderwidth = 2); (boxDisplayObject.graphicHeight = 42);
              (boxDisplayObject.graphicWidth = 25);
          break;
        case 20:
        ...
        case 19:
          ...
          break;
        case 18:
          (boxDisplayObject.start = 6); (boxDisplayObject.boxheight = 20); (boxDisplayObject.boxincwidth = 14);
              boxDisplayObject.iconbordermargin = 0.5; boxDisplayObject.iconborderheight = 19.5;
              boxDisplayObject.iconborderwidth = 13.5; boxDisplayObject.graphicHeight = 42;
              boxDisplayObject.graphicWidth = 25;
          break;
        case 17:
          (boxDisplayObject.start = 0xa); (boxDisplayObject.boxheight = 0x27); (boxDisplayObject.boxincwidth = 0x1c);
