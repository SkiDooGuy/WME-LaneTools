...
(function main() {
    ...
    function lanesTabSetup() {
        ...
        let fwdLanesEnabled = false,
            revLanesEnabled = false,
            rotateDisplayLanes = false;
        function _0x47ffa9() {
            W.model.nodes.get(W.selectionManager.getSegmentSelection().segments[0].attributes.toNodeID).attributes
                .geometry;
            ...
            if (_pickleColor >= 0x1 || editorInfo["editableCountryIDS"].length > 0x0) {
                ...
                $("#li-del-fwd-btn").click(function () {
                    ...
                    $("#li-del-opp-btn").click(function () {
                        ...
                        delLanes(_0x535f00),
                            _0x535f00 === "rev" ? (revLanesEnabled = true) : (fwdLanesEnabled = true),
                            _0x5a28b7();
                    });
            }
        ...
        function _0x1a7fee() {
            ...
            const _0x5ee852 = $(".fwd-lanes"),
                _0x3df49c = $(".rev-lanes");
            _0x5ee852.find(".apply-button.waze-btn.waze-btn-blue").click(() => {
                (fwdLanesEnabled = true),
                    setTimeout(function () {
                        _0x5a28b7();
                    }, 0xc8);
        ...
        function _0x414f9a() {
            ...
            if ($(".fwd-lanes").find(getString(0x2ea)).children().length > 0x0 && !getId(getString(0x453))) {
                ...
                add1MoreLane.appendTo(addMoreLanes),
                    ...
                    addMoreLanes["prependTo"](getString(0x310));
            }
            if ($(".rev-lanes").find(".lane-width-card").children().length > 0x0 && !getId(getString(0x420))) {
                ...
                append1Lane.appendTo(appendRevLanes),
                    ...
                    appendRevLanes.prependTo(getString(0x1fe));
            }
    ...
    function displayToolbar() {
        ...
        } else $("#lt-toolbar-container").css("display", "none");
    }
    ...
    function getCardinalAngle(_0x5f13ca, _0x261fce) {
        ...
        if (_0x1d47ac < 0x0) _0x1d47ac = _0x1d47ac + 360;
    ...
    function highlightSegment(
        ...
        function _0x43deae(_0x3291c0, _0xe37e1, _0x2d6773, _0x5e102e, _0x59dda1 = false) {
            if (_0x2d6773) {
                _0x58a03b(_0x3291c0.clone(), "" + LtSettings["ErrorColor"], _0x3c685d.OVER_HIGHLIGHT);
                return;
            }
            _0xe37e1 && _0x58a03b(_0x3291c0.clone(), "" + LtSettings.LIOColor, _0x3c685d.HIGHLIGHT);
            _0x40fe5d === 0x1 &&
                _0x4f1c1d &&
                _0x58a03b(_0x3291c0.clone(), "" + LtSettings.CS1Color, _0x3c685d.HIGHLIGHT);
            _0x40fe5d === 0x2 &&
                _0x4f1c1d &&
                _0x58a03b(_0x3291c0.clone(), "" + LtSettings.CS2Color, _0x3c685d["HIGHLIGHT"]);
            if (_0x5e102e === HeuristicsCandidate["PASS"])
                _0x58a03b(
                    _0x3291c0.clone(),
                    "" + LtSettings.HeurColor,
                    _0x59dda1 ? _0x3c685d.OVER_HIGHLIGHT : _0x3c685d["HIGHLIGHT"]
                );
            else
                    ...
                    if (_0x1d2584 === _0x3c685d.OVER_HIGHLIGHT)
                        ...
                        if (_0x1d2584 === _0x3c685d.DASH_THICK)
                            ...
                            _0x1d2584 === _0x3c685d.DASH_THIN &&
                                ...
                                _0x5501de.setAttribute("stroke-dasharray", "10\x2010"));
                    }
                }
            }
        }
    ...
    let lt_scanArea_timer = {
        ...
        calculate: function () {
            scanArea_real(), delete this.timeoutID;
        },
        cancel: function () {
    ...
    function scanSegments(_0x48b407, _0x553a1b) {
        ...
        _.each(_0x48b407, (_0x4e91a0) => {
            if (onScreen(_0x4e91a0, minZoomLevel)) {
                ...
                _0x1b6f52 =
                    _0x1b6f52 || _0x2ad725(_0x4e91a0, featureAttributes, Direction.FORWARD, _0x1ca2eb, _0x1b6f52);
                ...
                _0x1b6f52 =
                    _0x1b6f52 || _0x2ad725(_0x4e91a0, featureAttributes, Direction.REVERSE, _0x1ca2eb, _0x1b6f52);
                if (_0x1b6f52 && lt_scanArea_recursive > 0x0) {
                    lt_log("LT\x20errors\x20found,\x20scanning\x20again", 0x2),
                        removeHighlights(),
                        lt_scanArea_recursive--,
    ...
    function checkLanesConfiguration(segment, node, attachedSegments, laneCount) {
        ...
        const turnGraph = W.model.getTurnGraph(),
            zoomLevel = W.map.getZoom() != null ? W.map["getZoom"]() : 0x10;
        ...
        return (
            _0x44a7d8.length < laneCount && onScreen(node, zoomLevel) && (_0x16f110 = true),
                    ...
                    for (let _0x17365b = 0x0; _0x17365b < _0x58c806.length; _0x17365b++) {
                        if (_0x58c806[_0x17365b].checked === false) {
                            if (_0x17365b === 0x0 && (getId(getString(0x36b)).checked || _0x16a6be === false))
                                ...
                                if (
                                    _0x17365b === _0x58c806.length - 0x1 &&
    ...
    function isHeuristicsCandidate(
        ...
        if (_0x4e91d5 < 0x0 || _0x5063e3 < 0x0 || _0x96949d < 0x0)
            return (
                lt_log(
                    getString(0x3e5) + _0x453456 + "\x20(\x20" + Math["min"](_0x4e91d5, _0x5063e3, _0x96949d) + ")",
                    0x2
                ),
    ...
    function lt_segment_length(_0x59d9ca) {
        let segmentLength = _0x59d9ca.geometry.getGeodesicLength(W.map.olMap.projection);
        lt_log(
            "segment:" +
    ...
    function copyLaneInfo(nodeName) {
        ...
        for (let _0x578df3 = 0x0; _0x578df3 < attachedSegmentIDs.length; _0x578df3++) {
            const _0x53ad06 = getSegObj(attachedSegmentIDs[_0x578df3]);
            let _0x56f831 = _0x53ad06.getFeatureAttributes(),
                _0x1830fe = _0x53ad06.geometry.components,
                _0x165d3c,
                _0x5767e7,
                _0x207537 = turnGraph.getTurnThroughNode(nodeObj, featureObject, _0x53ad06).getTurnData();
            if (_0x207537.state === 0x1 && _0x207537.lanes) {
                _0x56f831.fromNodeID === nodeID ? (_0x5767e7 = "A") : (_0x5767e7 = "B");
    ...
    function pasteLaneInfo(_0x448ddd) {
        ...
        if (_turnInfo.length === _0x1b740b.length) {
            _0x448ddd === "A"
                ? mAction.doSubAction(new UpdateObj(featureObject, { revLaneCount: laneCount }))
    ...
    function displayLaneGraphics() {
        ...
        if (
            (wmeObject.attributes[getString(0x42f)] !== (0x3 || 0x6 || 0x7) && currentZoomLevel < 0x10) ||
        ...
        function _0x5694f9(_0x3399d1) {
            ...
            for (let _0xa51b27 = 0x0; _0xa51b27 < _0x3399d1.length; _0xa51b27++) {
                let _0x3ce23 = {};
                (_0x3ce23.uturn = $(_0x3399d1[_0xa51b27]).find(".uturn").css("display") !== "none"),
                    (_0x3ce23.miniuturn = $(_0x3399d1[_0xa51b27]).find(".small-uturn").css("display") !== "none"),
        ...
        function _0x19644c(_0x2866d6, _0x533989) {
            let _0x55da4e = _0x24ac62(),
                _0xc7a2c4 = getCardinalAngle(_0x2866d6.attributes.id, wmeObject),
                _0x1d852d,
                _0x55c2d7 = [],
                _0x1c3e29 = 0x0,
                                        ...
                                        if (_0xc7a2c4 > 0xd2 && _0xc7a2c4 < 0xf0)
                                            ...
                                            if (_0xc7a2c4 >= 0xf0 && _0xc7a2c4 <= 0x12c)
                                                ...
                                                _0xc7a2c4 > 0x12c && _0xc7a2c4 < 0x14a
                                                    ? ((_0xc7a2c4 -= 0xb4 - 0x2 * (360 - _0xc7a2c4)), (_0x1c3e29 = 0x5))
