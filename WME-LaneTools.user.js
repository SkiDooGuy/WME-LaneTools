    ...
    function
        main() {
          ...
          const LANETOOLS_VERSION = "" + GM_info.script.version,
                ...
                FORUM_LINK =
                    "https://www.waze.com/forum/viewtopic.php?f=819&t=30115",
                LI_UPDATE_NOTES =
                    "<b>NEW:</b><br>\x0a<b>FIXES:</b><br><br>\x0a",
                LANETOOLS_DEBUG_LEVEL = 0x1, configArray = {},
                RBSArray = {failed : false},
                IsBeta = location.href.indexOf("beta.waze.com") !== -0x1,
                TRANSLATIONS = {
                  default : {
                    enabled : "Enabled",
                    disabled : "Disabled",
                ...
                HeuristicsCandidate =
                    {ERROR : -2, FAIL : -1, NONE : 0, PASS : 1};
          let MAX_LEN_HEUR, MAX_PERP_DIF, MAX_PERP_DIF_ALT,
              MAX_PERP_TO_CONSIDER, MAX_STRAIGHT_TO_CONSIDER, MAX_STRAIGHT_DIF,
              lt_scanArea_recursive = 0x0, LtSettings = {}, strings = {},
              _turnInfo = [], _turnData = {}, laneCount, LTHighlightLayer,
              LTNamesLayer, LTLaneGraphics, _pickleColor, seaPickle, UpdateObj,
              MultiAction, SetTurn, shortcutsDisabled = false, isRBS = false,
              allowCpyPst = false, langLocality = "default", UPDATEDZOOM;
          ...
          function laneToolsBootstrap(bootStrapAttempt = 0x0) {
            if (W && W.map && W.model && W.loginManager.user && $ &&
              ...
              bootStrapAttempt < 500
                  ? setTimeout(
                        () => { laneToolsBootstrap(bootStrapAttempt++); }, 200)
          ...
          async function setupOptions() {
            function processOptionSettings() {
              ...
              !getId("lt-HighlightsEnable").checked &&
                  $("#lt-highlights-wrapper").hide();
              !getId("lt-LaneHeuristicsChecks").checked &&
            ...
            await loadSettings(), await loadSpreadsheet(),
                initLaneGuidanceClickSaver(),
                (LTHighlightLayer = new OpenLayers.Layer.Vector(
                     "LTHighlightLayer", {uniqueName : "_LTHighlightLayer"})),
                W.map.addLayer(LTHighlightLayer),
                LTHighlightLayer.setVisibility(true),
                (LTLaneGraphics = new OpenLayers.Layer.Vector(
                     "LTLaneGraphics", {uniqueName : "LTLaneGraphics"})),
            ...
            (LTNamesLayer = new OpenLayers.Layer.Vector("LTNamesLayer", {
              ...
              styleMap : new OpenLayers.StyleMap(style_map),
                ...
                W.map.addLayer(LTNamesLayer), LTNamesLayer.setVisibility(true),
                ...
                WazeWrap.Events.register("afteraction", null,
                                         displayLaneGraphics),
                WazeWrap.Events.register("afterundoaction", null, scanArea),
                WazeWrap.Events.register("afterundoaction", null,
                                         lanesTabSetup),
                WazeWrap.Events.register("afterundoaction", null,
                                         displayLaneGraphics),
            ...
            try {
              new WazeWrap.Interface
                  .Shortcut("enableHighlights", "Toggle\x20lane\x20highlights",
                            "wmelt", "Lane\x20Tools",
                            LtSettings.enableHighlights, toggleHighlights, null)
                  .add();
              new WazeWrap.Interface
                  .Shortcut("enableUIEnhancements",
                            "Toggle\x20UI\x20enhancements", "wmelt",
                            "Lane\x20Tools", LtSettings.enableUIEnhancements,
                            toggleUIEnhancements, null)
                  .add();
              new WazeWrap.Interface
                  .Shortcut("enableHeuristics",
                            "Toggle\x20heuristic\x20highlights", "wmelt",
                            "Lane\x20Tools", LtSettings.enableHeuristics,
                            toggleLaneHeuristicsChecks, null)
                  .add();
              new WazeWrap.Interface
                  .Shortcut("enableScript", "Toggle\x20script", "wmelt",
                            "Lane\x20Tools", LtSettings.enableScript,
                            toggleScript, null)
                  .add();
            } catch (err) {
              console.log(
                  ...
                  $("#lt-EnableShortcut")
                      .text("" + TRANSLATIONS.default.disabled),
            ...
            if (_pickleColor > 0x1) {
              ...
              isRBS && ($("#lt-serverSelectContainer").css("display", "block"),
                   ...
                   $(".lt-toolbar-button").click(function() {
                     $(this)[0x0].id === "copyA-button" && copyLaneInfo("A"),
                         $(this)[0x0].id === "copyB-button" &&
                             copyLaneInfo("B"),
                         $(this)[0x0].id === "pasteA-button" &&
                             pasteLaneInfo("A"),
                         $(this)[0x0].id === "pasteB-button" &&
                             pasteLaneInfo("B");
                   }),
                   (ltEnabledFeatures =
                        isRBS ? ltEnabledFeatures + ",\x20Copy/Paste"
            ...
            $(".lt-color-input").change(function() {
              ...
              saveSettings();
              $("#lt-" + color_input)
                  .css("border", "2px\x20solid" + this["value"]);
              removeHighlights();
              scanArea();
            });
            ...
            highlightsEnabledID.click(() => {
              getId("lt-HighlightsEnable").checked ? scanArea()
                                                   : removeHighlights(),
                  scanArea();
            });
            $("#lt-LabelsEnable").click(() => {
              getId("lt-LabelsEnable").checked
                  ? scanArea()
            ...
            $("#lt-LIOEnable").click(() => {
              getId("lt-LIOEnable").checked ? scanArea()
                                            : (removeHighlights(), scanArea());
            });
            $("#lt-IconsEnable").click(() => {
              getId("lt-IconsEnable").checked ? displayLaneGraphics()
                                              : removeLaneGraphics();
            });
            $("#lt-highlightOverride").click(() => {
              getId("lt-highlightOverride").checked
                  ? scanArea()
                  : (removeHighlights(), scanArea());
            });
            colorTitleID.click(() => { $("#lt-color-inputs").toggle(); });
            $("#lt-ClickSaveEnable")
                .click(() => { $(".lt-option-container.clk-svr").toggle(); });
            $("#lt-UIEnable").click(() => {
            ...
            $("#lt-LaneHeurPosHighlight").click(() => {
              getId("lt-LaneHeurPosHighlight").checked
                  ? scanArea()
                  : (removeHighlights(), scanArea());
            });
            $("#lt-LaneHeurNegHighlight").click(() => {
              getId("lt-LaneHeurNegHighlight").checked
                  ? scanArea()
                  : (removeHighlights(), scanArea());
            });
          ...
          async function loadSettings() {
            const parsedSettings =
                $.parseJSON(localStorage.getItem("LT_Settings")),
                  laneToolsSettings =
                      await WazeWrap.Remote.RetrieveSettings("LT_Settings");
            !laneToolsSettings &&
                console.error(
            ...
            if (laneToolsSettings && laneToolsSettings["lastSaveAction"] >
                                         LtSettings.lastSaveAction) {
              $.extend(LtSettings, laneToolsSettings);
            }

            Object.keys(settingsObject).forEach((propertyName) => {
              !LtSettings.hasOwnProperty(propertyName) &&
                  (LtSettings[propertyName] = settingsObject[propertyName]);
            });
          }
          ...
          async function saveSettings() {
            ...
            localStorage && localStorage.setItem(
                                "LT_Settings", JSON.stringify(savedLTSettings));
            const ltSettingsSaveStatus = await WazeWrap.Remote.SaveSettings(
                "LT_Settings", savedLTSettings);
          ...
          async function loadSpreadsheet() {
            ...
            const spreadsheetID = "AIzaSyDZjmkSx5xWc-86hsAIzedgDgRgy8vB7BQ",
                  angleFail = (_0x135a7d, _0x3e3ad5, errorMsg) => {
                    console.error("LaneTools:\x20Error\x20loading\x20settings:",
                                  errorMsg);
                  }, rbsFail = (_0x2d5151, _0x4e197b, reason) => {
                    console.error("LaneTools:\x20Error\x20loading\x20RBS:\x20",
                                  reason),
                        !RBSArray.failed &&
                    ...
                    console.error(
                        "LaneTools:\x20Error\x20loading\x20trans:\x20", err);
                  };
            try {
              await $
                  .getJSON(constantStrings.translationSpreadSheetBaseURL +
                           spreadsheetID)
                  .done(async (spreadSheetData) => {
                    spreadSheetData.values.length > 0x0
                        ? _.each(spreadSheetData.values,
                                 (translationValue) => {
                                   let localeName = translationValue[1];
                                   let translationsAvailable =
                                       Number.parseInt(translationValue[2],
                                                       10) === 1;
                                   !TRANSLATIONS[localeName] &&
                                       translationsAvailable &&
                                       (TRANSLATIONS[localeName] =
                                            JSON.parse(translationValue[0]));
                                 })
            ...
            try {
              await $
                  .getJSON(constantStrings.angleSpreadSheetBaseURL +
                           spreadsheetID)
                  .done((angleValueJSON) => {
                    angleValueJSON.values.length > 0x0
                        ? (_.each(angleValueJSON.values,
                                  (angleValue) => {
                                    !configArray[angleValue[1]] &&
                                        (configArray[angleValue[1]] =
                                             JSON.parse(angleValue[0]));
                                  }),
            ...
            try {
              await $
                  .getJSON(constantStrings.RBSAccessSheetBaseURL +
                           spreadsheetID)
                  .done((rbsValueJSON) => {
                    if (rbsValueJSON.values.length > 0x0) {
                      for (let idx = 0x0; idx < rbsValueJSON.values.length;
                           idx++) {
          ...
          function setTranslations() {
            ...
            if (TRANSLATIONS[langLocality])
              ...
              langLocality.includes("-") &&
                      TRANSLATIONS[langLocality.split("-")[0x0]]
            ...
            Object.keys(TRANSLATIONS.default).forEach((propertyName) => {
              (!strings.hasOwnProperty(propertyName) ||
               strings[propertyName] === "") &&
                  (strings[propertyName] =
                       TRANSLATIONS.default[ propertyName ]);
            });
            ...
            $("#lt-color-title")
                .attr("data-original-title", strings["colTooltip"]);
            shortcutsDisabled &&
          ...
          function setHeuristics() {
            if (RBSArray.failed)
              return;
            let config = isRBS && getId("lt-serverSelect").checked
                             ? configArray.RBS
                             : configArray.RPS;
          ...
          function checkShortcutsChanged() {
            ...
            for (const actionValue in W.accelerators.Actions) {
              const {shortcut : shortCutValue, group : groupValue} =
                  W.accelerators.Actions[actionValue];
              if (groupValue === "wmelt") {
                let shortCutString = "";
                shortCutValue
                    ? (shortCutValue["altKey"] === true &&
                           (shortCutString += "A"),
                       shortCutValue["shiftKey"] === true &&
                           (shortCutString += "S"),
                       shortCutValue["ctrlKey"] === true &&
                           (shortCutString += "C"),
                       shortCutString !== "" && (shortCutString += "+"),
                       shortCutValue["keyCode"] &&
                           (shortCutString += shortCutValue["keyCode"]))
                    : (shortCutString = "-1");
                if (LtSettings[actionValue] !== shortCutString) {
                  (shortCutInvoked = true),
                      console.log("LaneTools:\x20Stored\x20shortcut\x20" +
                                  actionValue + ":\x20" +
                                  LtSettings[actionValue] +
                                  "changed\x20to\x20" + shortCutString);
                  break;
                }
              }
            }
          ...
          function getKeyboardShortcut(settingValue) {
            ...
            if (keyboardShortCut.indexOf("+") > -0x1) {
              ...
              keyboardKey >= 0x60 && keyboardKey <= 0x69 &&
                  ((keyboardKey -= 48), (shortCutValue += "[num\x20pad]")),
                  (shortCutValue += String.fromCharCode(keyboardKey));
            }
          ...
          function updateShortcutLabels() {
            !shortcutsDisabled &&
                ($("#lt-EnableShortcut")
                     .text(getKeyboardShortcut("enableScript")),
                 $("#lt-HighlightShortcut")
                     .text(getKeyboardShortcut("enableHighlights")),
                 $("#lt-UIEnhanceShortcut")
                     .text(getKeyboardShortcut("enableUIEnhancements")),
                 $("#lt-LaneHeurChecksShortcut")
                     .text(getKeyboardShortcut("enableHeuristics")));
          }
          ...
          function lanesTabSetup() {
            if (getId("edit-panel").getElementsByTagName("wz-tabs").length ==
                0x0) {
            ...
            let fwdLanesEnabled = false, revLanesEnabled = false,
                rotateDisplayLanes = false;
            function _0x47ffa9() {
              W.model.nodes
            ...
            function _0x5a28b7() {
              ...
              if (_pickleColor >= 0x1 ||
                  editorInfo["editableCountryIDS"].length > 0x0) {
                ...
                let _0x8b5acb = $(
                    ...
                    _0x55302b = $(
                        "<div\x20style=\x22display:inline-block;position:relative;\x22\x20/>");
                _0x8b5acb.appendTo(_0x52f96d), _0x2f9ee4.appendTo(_0x52daad),
                ...
                if (!getId("li-del-rev-btn") && !revLanesEnabled &&
                    selectedFeatures[0x0]
                            .attributes.wazeFeature._wmeObject.getRevLanes()
                            .laneCount > 0x0) {
                  if ($(constantStrings.revLanesInstructionsFromCSS).length >
                      0x0)
                    _0x52daad.prependTo(
                        constantStrings.revLanesInstructionsFromCSS),
                        $(constantStrings.revLanesInstructionsFromCSS)
                            .css("border-bottom",
                                 "4px dashed " + LtSettings.BAColor);
                  else
                    selectedFeatures[0x0]
                                .attributes.wazeFeature._wmeObject.attributes
                                .revDirection != true &&
                        (_0x336aa4.prop("title", "rev"),
                         _0x336aa4.prependTo(constantStrings.editPanelCSS));
                } else
                  $(constantStrings.revLanesInstructionsFromCSS)
                      .css("border-bottom",
                           "4px\x20dashed\x20" + LtSettings.BAColor);
                if (!getId("li-del-fwd-btn") && !fwdLanesEnabled &&
                    selectedFeatures[0x0]
                            .attributes.wazeFeature._wmeObject.getFwdLanes()
                            .laneCount > 0x0) {
                  if ($(constantStrings.fwdLanesDivInstructionCSS).length > 0x0)
                    _0x52f96d.prependTo(
                        constantStrings.fwdLanesDivInstructionCSS),
                        $(constantStrings.fwdLanesDivInstructionCSS)
                            .css("border-bottom",
              ...
              editLaneGuidance.off(), editLaneGuidance.click(function() {
                $(this).parents(".fwd-lanes").length &&
                    setTimeout(
                        function() {
                          _0x16065d("fwd"), _0x414f9a(), _0x816cf7(),
                              _0x3e0f42(), _0x1a7fee();
                    ...
                    $(this).parents(".rev-lanes").length &&
                        setTimeout(function() {
                          _0x16065d("rev"), _0x414f9a(), _0x816cf7(),
                              _0x3e0f42(), _0x1a7fee();
                          if (getId("lt-AddTIO").checked)
                            addTIOUI("rev");
                        }, 0x64);
            ...
            function _0x2308e1() {
              ...
              getId("lt-AutoOpenWidth").checked &&
                  (!fwdLanesEnabled &&
                       $(".fwd-lanes")
                           .find(".set-road-width\x20>\x20wz-button")
                           .click(),
                   !revLanesEnabled &&
                       $(".rev-lanes")
                           .find(".set-road-width\x20>\x20wz-button")
            ...
            function _0x816cf7() {
              $(".fwd-lanes\x20>\x20div\x20>\x20.direction-lanes").css({
                ...
                "margin-bottom" : "10px",
                  ...
                  $(constantStrings.fwdLanesDirectionControlEditCSS)
                      .css("padding-top", "10px"),
                  $(constantStrings.revLanesInstructionsToCSS)
                      .css("padding-top", "10px"),
                  $(constantStrings.fwdLanesLaneInstrunctionToCSS)
            ...
            function _0x414f9a() {
              if ($(".fwd-lanes").find(".direction-lanes").children().length >
                      0x0 &&
                  !getId("lt-fwd-add-lanes")) {
                let add1Lane =
                        $("<div\x20class=\x22lt-add-lanes\x20fwd\x22>1</div>"),
                    add2Lanes =
                        $("<div\x20class=\x20lt-add-lanes\x20fwd\x22>2</div>"),
                    add3Lanes =
                        $("<div\x20class=\x22t-add-lanes\x20fwd\x22>3</div>"),
                    add4Lanes =
              ...
              if ($(".rev-lanes").find(".direction-lanes").children().length >
                      0x0 &&
                  !getId("lt-rev-add-lanes")) {
                let add1ReverseLane =
              ...
              if ($(".fwd-lanes").find(".lane-width-card").children().length >
                      0x0 &&
                  !getId("lt-fwd-add-Width")) {
                let add1MoreLane =
                        $("<div\x20class=\x22lt-add-Width\x20fwd\x22>1</div>"),
                    add2MoreLanes =
                        $("<div\x20class=\x22lt-add-Width\x20fwd\x22>2</div>"),
                    add3MoreLanes =
                        $("<div\x20class=\x22lt-add-Width\x20fwd\x22>3</div>"),
                    add4MoreLanes =
                    ...
                    add7MoreLanes =
                        $("<div\x20class=\x22lt-add-Width\x20fwd\x22>7</div>"),
                    add8MoreLanes =
              ...
              if ($(".rev-lanes").find(".lane-width-card").children().length >
                      0x0 &&
                  !getId("lt-rev-add-Width")) {
                let append1Lane =
                        $("<div\x20class=\x22lt-add-Width\x20rev\x22>1</div>"),
                    append2Lanes =
                        $("<div\x20class=\x22lt-add-Width\x20rev\x22>2</div>"),
                    append3Lanes =
                        $("<div\x20class=\x22lt-add-Width\x20rev\x22>3</div>"),
                    append4Lanes =
                        $("<div\x20class=\x22lt-add-Width\x20rev\x22>4</div>"),
                    append5Lanes =
              ...
              $(".lt-add-Width").click(function() {
                ...
                if ($(this).hasClass("lt-add-Width\x20fwd")) {
                  ...
                  fwdLanes.find("#number-of-lanes").val(numLanesToAdd),
                ...
                if ($(this).hasClass("lt-add-Width\x20rev")) {
                  ...
                  revLanes.find("#number-of-lanes").val(numLanesToAdd),
            ...
            function _0x3e0f42() {
              if (getId("lt-AutoFocusLanes").checked) {
                ...
                if (_0x3797e1.find(".edit-region").children().length > 0x0 &&
                    !fwdLanesEnabled)
                  _0x3797e1.find(".form-control").focus();
                else
                  _0x36859d.find(".edit-region").children().length > 0x0 &&
                      !revLanesEnabled &&
              ...
              if (getId("lt-SelAllEnable").checked) {
                ...
                $(_0x430051).change(function() {
                  ...
                  if ($(this).parents(".fwd-lanes").length)
                    _0x2588e2 = $(".fwd-lanes")
                                    .find(".controls-container.turns-region");
                  else
                    $(this).parents(".rev-lanes").length &&
                        (_0x2588e2 =
                             $(".rev-lanes")
            ...
            function _0x50c216() {
              const segmentRef =
                  selectedFeatures[0x0].attributes.wazeFeature._wmeObject,
              ...
              let _0x54880b = checkLanesConfiguration(
                      segmentRef, bNodeRef, bNodeRef.attributes.segIDs,
                      segmentRef.attributes.fwdLaneCount),
                  _0x21c6d0 = checkLanesConfiguration(
                      segmentRef, aNodeRef, aNodeRef.attributes.segIDs,
                      segmentRef.attributes.revLaneCount);
              if (_0x54880b[0x4] > 0x0) {
                let _0x59815e = _0x54880b[0x4] === 0x1 ? LtSettings.CS1Color
                                                       : LtSettings.CS2Color,
                    _0x1d2fa0 =
                ...
                for (let i = 0x0; i < _0x1d2fa0.length; i++) {
                  _0x1d2fa0[i]["title"] == _0x54880b[0x5] &&
                      $(_0x1d2fa0[i]).css("background-color", _0x59815e);
                }
              }
              if (_0x21c6d0[0x4] > 0x0) {
                let _0xc39df0 = _0x21c6d0[0x4] === 0x1 ? LtSettings.CS1Color
                                                       : LtSettings.CS2Color,
            ...
            function _0x8ccdf2() {
              let headingElement = document.getElementsByClassName("heading"),
                  _0x2b66d6 = $(".lane-arrows\x20>\x20div").get();
              for (let idx = 0x0; idx < headingElement.length; idx++) {
                if (headingElement[idx].textContent.includes("south")) {
                  ...
                  $(kids).css("transform", "rotate(180deg)"),
                      $(_0x2b66d6[idx]).append(kids.get().reverse());
                }
              }
            ...
            if (getId("lt-UIEnable").checked &&
                getId("lt-ScriptEnabled").checked &&
                selectedFeatures.length > 0x0) {
              if (selectedFeatures.length === 0x1 &&
                  selectedFeatures[0x0]
                          .attributes.wazeFeature._wmeObject.type ===
                      "segments")
                $(".lanes-tab").click(() => {
                  (fwdLanesEnabled = false), (revLanesEnabled = false),
                      setTimeout(() => { _0x5a28b7(); }, 100);
                }),
                    getId("lt-AutoLanesTab").checked &&
                        setTimeout(() => { $(".lanes-tab").click(); }, 100);
              else
                selectedFeatures.length === 0x2 &&
                    scanHeuristicsCandidates(selectedFeatures);
            }
          }
          ...
          function displayToolbar() {
            ...
            if (_0x4afd09.length === 0x1 && getId("lt-CopyEnable").checked &&
                getId("lt-ScriptEnabled").checked) {
              if (_0x4afd09[0x0]
                      .attributes.wazeFeature._wmeObject.type.toLowerCase() ===
                  "segments") {
                const _0x5df401 = $("#map");
          ...
          function onScreen(_0x1d94fe, _0x4edaf4) {
            ...
            if (_0x4edaf4 >= DisplayLevels["MIN_ZOOM_NONFREEWAY"] ||
                (_0x1d94fe.type === "segments" &&
                 _0x1d94fe.attributes["roadType"] === LT_ROAD_TYPE.FREEWAY))
              return W.map.getExtent().intersectsBounds(
                  _0x1d94fe.geometry.getBounds());
            return false;
          }
          function getCardinalAngle(_0x5f13ca, _0x261fce) {
            ...
            _0x261fce.attributes.fromNodeID === _0x5f13ca
                ? ((_0x529918 = lt_get_second_point(_0x261fce).x -
                                lt_get_first_point(_0x261fce).x),
                   (_0x573f8b = lt_get_second_point(_0x261fce).y -
                                lt_get_first_point(_0x261fce).y))
                : ((_0x529918 = lt_get_next_to_last_point(_0x261fce).x -
                                lt_get_last_point(_0x261fce).x),
                   (_0x573f8b = lt_get_next_to_last_point(_0x261fce).y -
                                lt_get_last_point(_0x261fce).y));
            let _0x45f593 = Math.atan2(_0x573f8b, _0x529918),
                _0x1d47ac = ((_0x45f593 * 0xb4) / Math.PI) % 360;
            if (_0x1d47ac < 0x0)
          ...
          function lt_get_last_point(_0x5c9b90) {
            return _0x5c9b90.geometry
                .components[_0x5c9b90.geometry.components.length - 0x1];
          }
          ...
          function lt_get_next_to_last_point(_0x2ea5d3) {
            return _0x2ea5d3.geometry
                .components[_0x2ea5d3.geometry.components.length - 0x2];
          }
          ...
          function delLanes(laneDirection) {
            ...
            for (let idx = 0x0; idx < attachedSegmentIDs.length; idx++) {
              let _0x58ea8c = turnGraph.getTurnThroughNode(
                      nodeObject, wmeObject,
                      getSegObj(attachedSegmentIDs[idx])),
          ...
          function highlightSegment(segGeom, segDirection, highlightEnabled,
                                    highlightLabelsEnabled, _0x126e8a,
                                    _0x2c9162, _0x147e33, _0x40fe5d, _0x42e2ed,
                                    _0x701156, _0x2a289c) {
            const _0x3c685d = {
              DASH_THIN : 0x1,
              DASH_THICK : 0x2,
              ...
              OVER_HIGHLIGHT : 0x14,
                  ...
                  _0x1d1809 = segGeom.clone(),
                  _0x4f1c1d = getId("lt-CSEnable").checked;
            if (_0x1d1809.components.length > 0x2) {
              let _0x114781 = _0x1d1809.components.length,
                  _0x17a8e9 = _0x114781 / 0x2,
                  _0x5479ec = _0x114781 % 0x2 ? Math.ceil(_0x17a8e9) - 0x1
                                              : Math.ceil(_0x17a8e9),
                  _0x3a7f64 = _0x114781 % 0x2 ? Math.floor(_0x17a8e9) + 0x1
                                              : Math.floor(_0x17a8e9);
              if (segDirection === Direction.FORWARD) {
                let _0x21e1e8 = _0x1c40ca(_0x1d1809, _0x5479ec, _0x114781);
                highlightEnabled &&
                    _0x58a03b(_0x21e1e8, "" + LtSettings.ABColor,
                              _0x3c685d.DASH_THIN),
                    _0x43deae(_0x21e1e8, _0x147e33, _0x42e2ed, _0x701156,
                              _0x2a289c);
              } else {
                if (segDirection === Direction.REVERSE) {
                  let _0x3e6b6f = _0x1c40ca(_0x1d1809, 0x0, _0x3a7f64);
                  highlightEnabled &&
                      _0x58a03b(_0x3e6b6f, "" + LtSettings.BAColor,
                                _0x3c685d.DASH_THIN),
                      _0x43deae(_0x3e6b6f, _0x147e33, _0x42e2ed, _0x701156,
                                _0x2a289c);
                }
              }
              if (highlightLabelsEnabled &&
                  (Direction.FORWARD || _0x126e8a === 0x0)) {
                if (_0x114781 % 0x2)
                  applyName(_0x1d1809.components[_0x5479ec], _0x126e8a,
                            _0x2c9162);
                else {
              ...
              if (segDirection === Direction.FORWARD) {
                let _0x196538 = new OpenLayers.Geometry.Point(
                    ...
                    _0x13e81d = new OpenLayers.Geometry["LineString"](
                        [ _0xa8356b, _0x196538 ], {});
                highlightEnabled &&
                    _0x58a03b(_0x13e81d, "" + LtSettings.ABColor,
                              _0x3c685d.DASH_THIN),
                    _0x43deae(_0x13e81d, _0x147e33, _0x42e2ed, _0x701156,
                              _0x2a289c);
              } else {
                if (segDirection === Direction.REVERSE) {
                  let _0x4c870d = new OpenLayers.Geometry.Point(
                      ...
                      _0x598bfa = new OpenLayers.geometry.LineString(
                          [ _0xa8356b, _0x4c870d ], {});
                  highlightEnabled &&
                      _0x58a03b(_0x598bfa, "" + LtSettings["BAColor"],
                                _0x3c685d["DASH_THIN"]),
                      _0x43deae(_0x598bfa, _0x147e33, _0x42e2ed, _0x701156,
                                _0x2a289c);
                }
              }
            ...
            function _0x1c40ca(_0x1226a0, _0x5d1ef6, _0x2d2248) {
              let _0x3411db = [];
              for (let _0x191254 = _0x5d1ef6; _0x191254 < _0x2d2248;
                   _0x191254++) {
                _0x3411db[_0x191254] = _0x1226a0.components[_0x191254].clone();
              }
              return new OpenLayers.Geometry.LineString(_0x3411db, {});
            }
            function _0x43deae(_0x3291c0, _0xe37e1, _0x2d6773, _0x5e102e,
                               _0x59dda1 = false) {
              if (_0x2d6773) {
                _0x58a03b(_0x3291c0.clone(), "" + LtSettings["ErrorColor"],
                          _0x3c685d.OVER_HIGHLIGHT);
                return;
              }
              _0xe37e1 && _0x58a03b(_0x3291c0.clone(), "" + LtSettings.LIOColor,
                                    _0x3c685d.HIGHLIGHT);
              _0x40fe5d === 0x1 && _0x4f1c1d &&
                  _0x58a03b(_0x3291c0.clone(), "" + LtSettings.CS1Color,
                            _0x3c685d.HIGHLIGHT);
              _0x40fe5d === 0x2 && _0x4f1c1d &&
                  _0x58a03b(_0x3291c0.clone(), "" + LtSettings.CS2Color,
                            _0x3c685d["HIGHLIGHT"]);
              if (_0x5e102e === HeuristicsCandidate["PASS"])
                _0x58a03b(_0x3291c0.clone(), "" + LtSettings.HeurColor,
                          _0x59dda1 ? _0x3c685d.OVER_HIGHLIGHT
                                    : _0x3c685d["HIGHLIGHT"]);
              else
              ...
              if (_0x5501de) {
                ...
                if (_0x1d2584 === _0x3c685d.HIGHLIGHT)
                  ...
                  if (_0x1d2584 === _0x3c685d.OVER_HIGHLIGHT)
                    ...
                    if (_0x1d2584 === _0x3c685d.DASH_THICK)
                      _0x5501de.setAttribute("stroke-width", "8"),
                          _0x5501de.setAttribute("stroke-dasharray", "8\x2010");
                    else
                      _0x1d2584 === _0x3c685d.DASH_THIN &&
                          (_0x5501de.setAttribute("stroke-width", "4"),
                           _0x5501de.setAttribute("stroke-dasharray",
                                                  "10\x2010"));
                  }
                }
              }
          ...
          function highlightNode(_0x468e12, _0xcc8670, _0x5c426d = false) {
            ...
            _0x2bd47a && (_0x2bd47a.setAttribute("fill", _0xcc8670),
                          _0x2bd47a.setAttribute("r", _0x5c426d ? "18" : "10"),
                          _0x2bd47a.setAttribute("fill-opacity", "0.9"),
                          _0x2bd47a.setAttribute("stroke-width", "0"));
          }
          let lt_scanArea_timer = {
            start : function() {
              ...
              let _0x150ba4 = this;
              this["timeoutID"] =
                  window.setTimeout(function() { _0x150ba4.calculate(); }, 500);
            },
          ...
          function scanArea_real() {
            const scriptEnabled = getId("lt-ScriptEnabled").checked,
                  ...
                  heuristicsChecksEnabled =
                      getId("lt-LaneHeuristicsChecks").checked,
                  currentZoomLevel =
                      W.map.getZoom() != null ? W.map["getZoom"]() : 16,
          ...
          function scanHeuristicsCandidates(_0x482def) {
            ...
            return (_.each(_0x482def, (_0x249a9b) => {
              _0x249a9b && _0x249a9b.attributes.wazeFeature._wmeObject &&
                  _0x249a9b.attributes.wazeFeature._wmeObject.type ===
                      "segments" &&
                  (_0x232b3f = _0x4174e4.push(
          ...
          function scanSegments(_0x48b407, _0x553a1b) {
            const checkHeuristics = getId("lt-LaneHeuristicsChecks").checked,
                  heurPosHighlightEnabled =
                      checkHeuristics &&
                      getId("lt-LaneHeurPosHighlight").checked,
                  heurNegHighlightEnabled =
                      checkHeuristics &&
                      getId("lt-LaneHeurNegHighlight").checked,
                  highlightEnabled = getId("lt-HighlightsEnable").checked,
                  highlightLIOEnabled =
                      highlightEnabled && getId("lt-LIOEnable").checked,
                  highlightLabelsEnabled =
                      highlightEnabled && getId("lt-LabelsEnable").checked,
                  minZoomLevel = W.map.getZoom() != null ? W.map.getZoom() : 16,
                  turnGraph = W.model.getTurnGraph();
            _.each(_0x48b407, (_0x4e91a0) => {
              if (onScreen(_0x4e91a0, minZoomLevel)) {
                ...
                _0x1b6f52 = _0x1b6f52 ||
                            _0x2ad725(_0x4e91a0, featureAttributes,
                                      Direction.FORWARD, _0x1ca2eb, _0x1b6f52);
                if (_0x1b6f52 && lt_scanArea_recursive > 0x0) {
                  lt_log("LT\x20errors\x20found,\x20scanning\x20again", 0x2),
                      removeHighlights(), lt_scanArea_recursive--,
                      lt_scanArea_timer.start();
                  return;
                }
                _0x1b6f52 = _0x1b6f52 ||
                            _0x2ad725(_0x4e91a0, featureAttributes,
                                      Direction.REVERSE, _0x1ca2eb, _0x1b6f52);
                if (_0x1b6f52 && lt_scanArea_recursive > 0x0) {
                  lt_log("LT\x20errors\x20found,\x20scanning\x20again", 0x2),
                      removeHighlights(), lt_scanArea_recursive--,
                      lt_scanArea_timer.start();
            ...
            function _0x2ad725(_0x6f84fd, segmentObj, _0x17336c, _0x37b92d,
                               _0x402e4b) {
              ...
              let _0x5855dd = false, _0x4d3a78 = false, _0x12606 = false,
                  _0x58ba1e = false, _0x3a8c59 = 0x0,
              ...
              if (onScreen(toNode, minZoomLevel)) {
                ...
                if (fLaneCount > 0x0) {
                  let _0x30b899 = checkLanesConfiguration(
                      _0x6f84fd, toNode, toNodeAttachedSegmentIDs, fLaneCount);
                  (_0x5855dd = _0x30b899[0x0]), (_0x4d3a78 = _0x30b899[0x1]),
                      (_0x58ba1e = _0x30b899[0x2]), (_0x12606 = _0x30b899[0x3]),
                      (_0x3a8c59 = _0x30b899[0x4]),
                      (_0x402e4b = _0x12606 || _0x402e4b);
                }
                if (_0x37b92d <= MAX_LEN_HEUR) {
                  heurCandidate = isHeuristicsCandidate(
                      _0x6f84fd, toNode, toNodeAttachedSegmentIDs, fromNode,
                      fLaneCount, _0x37b92d, turnGraph, _0x211d6a);
                  heurCandidate === HeuristicsCandidate["ERROR"] &&
                      (_0x12606 = true);
                  if (!checkHeuristics)
              ...
              if (!_0x553a1b) {
                ...
                ((heurPosHighlightEnabled &&
                 ...
                 (heurNegHighlightEnabled &&
                  heurCandidate === HeuristicsCandidate.FAIL)) &&
                    (_0x5c9960 = heurCandidate),
                    (fLaneCount > 0x0 || _0x5c9960 !== null || _0x12606) &&
                        highlightSegment(
                            _0x6f84fd.geometry, _0x17336c, highlightEnabled,
                            highlightLabelsEnabled, fwdLaneCount, revLaneCount,
                            _0x58ba1e && highlightLIOEnabled, _0x3a8c59,
                            _0x12606, _0x5c9960, false),
                    highlightEnabled && getId("lt-NodesEnable").checked &&
                        (_0x5855dd && highlightNode(toNode.geometry,
                                                    "" + LtSettings.NodeColor),
                         _0x4d3a78 && highlightNode(toNode.geometry,
                                                    "" + LtSettings.TIOColor));
              } else {
                ...
                if (heurCandidate !== HeuristicsCandidate.NONE) {
                  if (_0x53f387 != null &&
                      _0x48b407["findIndex"](
                          (_0x12b968) => _0x12b968 === _0x53f387.seg) > -0x1) {
                    let _0x4063ba = heurCandidate === HeuristicsCandidate.PASS
                                        ? "" + LtSettings.NodeColor
                                        : "" + LtSettings.HeurFailColor;
                    highlightSegment(_0x6f84fd.geometry, _0x17336c, false,
                                     false, 0x0, 0x0, false, _0x3a8c59,
                                     _0x12606, heurCandidate, true),
                        highlightSegment(_0x53f387["seg"].geometry,
                                         _0x53f387.direction, false, false, 0x0,
                                         0x0, false, 0x0, false, heurCandidate,
                                         true),
          ...
          function checkLanesConfiguration(segment, node, attachedSegments,
                                           laneCount) {
            let _0x739f97 = false, _0x55ea18 = false, _0x16f110 = false,
                _0x161259 = false, _0x5c5507 = 0x0, _0x4211dc = null,
                _0x44a7d8 = [];
            const turnGraph = W.model.getTurnGraph(),
                  zoomLevel =
                      W.map.getZoom() != null ? W.map["getZoom"]() : 0x10;
            for (let idx = 0x0; idx < attachedSegments.length; idx++) {
              const attachedSegment = getSegObj(attachedSegments[idx]),
                    turnData =
                        turnGraph
                            .getTurnThroughNode(node, segment, attachedSegment)
                            .getTurnData();
              if (turnData.state === 0x1) {
                turnData["hasInstructionOpcode"]() && (_0x55ea18 = true);
                if (turnData["hasLanes"]()) {
                  _0x739f97 = true;
                  turnData.getLaneData().hasOverrideAngle() &&
                      (_0x161259 = true);
                  if (turnData.getLaneData().getGuidanceMode() === 0x1)
                    ...
                    turnData.getLaneData().getGuidanceMode() === 0x2 &&
                        ((_0x5c5507 = 0x2),
                         (_0x4211dc =
                              W.model.streets
                                  .getObjectById(attachedSegment.attributes
                                                     .primaryStreetID)
                                  .name));
            ...
            return (_0x44a7d8.length < laneCount && onScreen(node, zoomLevel) &&
                        (_0x16f110 = true),
                    [
                      _0x739f97, _0x55ea18, _0x161259, _0x16f110, _0x5c5507,
                      _0x4211dc
                    ]);
          }
          function setTurns(_0x32e1b9) {
            ...
            let _0x1357ab = document.getElementsByClassName(_0x32e1b9)[0x0],
                _0x3ce173 =
                    _0x1357ab["getElementsByClassName"]("angle--135").length >
                            0x0
                        ? "angle--135"
                        : _0x1357ab["getElementsByClassName"]("angle--90")
                                      .length > 0x0
                              ? "angle--90"
                              : "angle--45",
            _0x217ae4 =
            ...
            if (_0x257aea === 0x0) {
              for (let idx = 0x0; idx < _0x3541df.length; idx++) {
                ...
                if (_0x5c6270 && _0x5c6270.length > 0x0) {
                  if (_0x496f7c.getElementsByClassName(_0x3ce173).length >
                          0x0 &&
                    ...
                    _0x496f7c.getElementsByClassName(_0x217ae4).length > 0x0 &&
                        _0x5c6270[_0x5c6270.length - 0x1].checked !==
                            undefined &&
                        _0x5c6270[_0x5c6270.length - 0x1].checked === false &&
                        getId("lt-ClickSaveTurns").checked &&
                        ((_0x43ae0b = true),
                         _0x5c6270[_0x5c6270.length - 0x1].click());
                }
              }
              for (let idx = 0x0; idx < _0x3541df.length; idx++) {
                const _0x376ec2 = _0x3541df[idx];
                let _0x58c806 =
                    _0x376ec2.getElementsByTagName("wz-checkbox");
                if (_0x376ec2.getElementsByClassName("angle-0").length >
                    0x0)
                  for (let idx = 0x0; idx < _0x58c806.length;
                       idx++) {
                    if (_0x58c806[idx].checked === false) {
                      if (idx === 0x0 &&
                        ...
                        if (idx === _0x58c806.length - 0x1 &&
                            (getId("lt-ClickSaveStraight").checked ||
                             _0x43ae0b === false))
                          _0x58c806[idx].click();
                        else
                          idx !== 0x0 &&
                              idx !== _0x58c806.length - 0x1 &&
                              _0x58c806[idx].click();
                      }
                    }
                  }
                ...
                for (let idx = 0x0; idx < _0x21e4b9.length; idx++) {
                  _0x21e4b9[idx].addEventListener("change", function() {
                    let _0x2cc679 = $(this).parents().eq(0x9),
                        _0x80b8a5 =
                            _0x2cc679[0x0].parentElement.className;
          ...
          function isHeuristicsCandidate(
              _0x2bb3f1, toNodeObj, attachedSegmentIDs, fromNodeObj,
              fwdLaneCount, _0x25826c, _0x5aa7bb, _0x1a610d) {
            if (_0x2bb3f1 == null || toNodeObj == null ||
                attachedSegmentIDs == null || fromNodeObj == null ||
            ...
            let _0x1859f0 = null, _0x4f9be7 = null, _0x96949d = 0x0,
                _0x4777ff = null, _0x28857a = null, _0x96fad4 = null,
                _0x4e91d5 = 0x0, _0x4fd61c = null, _0x1c6b60 = null,
                _0x5063e3 = 0x0, _0x296190 = 0x0;
            ...
            let _0x11d184 = _0x43a6d2(toNodeObj.attributes.id, _0x2bb3f1),
                ...
                _0x18525c = -90, _0x26651c = 90;
            W.model.isLeftHand && ((_0x18525c = 90), (_0x26651c = -90));
            lt_log(
                "==================================================================================",
                0x2);
                lt_log("Checking\x20heuristics\x20candidate:\x20seg" +
                           _0x453456 + "node" + toNodeObj.attributes.id +
                           "\x20azm\x20" + _0x11d184 + "nodeExitSegIds:" +
            ...
            for (let idx = 0x0; idx < segmentIDs.length; idx++) {
              ...
              lt_log("Turn\x20angle\x20from\x20inseg\x20" +
                         segmentIDs[idx] + ":\x20" + _0x4ef283 + "(" +
                         _0x3c6b23 + "," + _0x5349e1 + ")",
                     0x3);
              if (Math.abs(_0x4ef283) > MAX_STRAIGHT_DIF) {
                if (Math.abs(_0x4ef283) > MAX_STRAIGHT_TO_CONSIDER)
                  continue;
                lt_log("Not\x20eligible\x20as\x20inseg:\x20" + _0x4ef283, 0x2),
                    (heurState = HeuristicsCandidate.FAIL);
              }
              const _0x4c0fc6 = _0x5aa7bb.getTurnThroughNode(
                  fromNodeObj, _0x71a39c, _0x2bb3f1),
                    _0x264c0a = _0x4c0fc6.getTurnData();
              if (_0x264c0a.state !== 0x1 || !_0x264c0a.hasLanes()) {
                lt_log("Straight\x20turn\x20has\x20no\x20lanes:" + segmentIDs[idx] + "\x20to\x20" +
                           _0x453456,
                       0x3);
                continue;
              }
              let idxDiff = _0x264c0a.lanes.toLaneIndex -
                              _0x264c0a.lanes.fromLaneIndex + 0x1;
              idxDiff !== fwdLaneCount &&
                  !(fwdLaneCount === 0x0 && idxDiff === 0x1) &&
                  (lt_log(
                       "Straight\x20turn\x20lane\x20count\x20does\x20not\x20match",
                       0x2),
              ...
              if (_0x4777ff !== null && heurState >= _0x4e91d5) {
                if (_0x4e91d5 === 0x0 && heurState === 0x0)
                  return (
                      lt_log("Error:\x20>1\x20qualifying\x20entry\x20segment\x20for\x20" + _0x2bb3f1.attributes.id +
                                 ":\x20" + _0x4777ff.attributes.id + "," +
              ...
              (_0x4777ff = _0x71a39c), (_0x28857a = _0x3c6b23),
                  (_0x96fad4 = _0x4ef283), (_0x296190 = idxDiff),
                  (_0x4e91d5 = heurState),
                  (_0x1a610d.inSeg= _0x4777ff),
                  (_0x1a610d.inSegDir =
                       _0x4c0fc6.fromVertex["direction"] === "fwd"
                           ? Direction.FORWARD
                           : Direction["REVERSE"]);
            }
            if (_0x4777ff == null)
              return lt_log("==\x20No\x20inseg\x20found\x20==================================================================", 0x2), 0x0;
            else
              lt_log("Found\x20inseg\x20candidate:\x20" +
                         _0x4777ff.attributes.id + "\x20" +
                         (_0x4e91d5 === 0x0 ? "" : "(failed)"),
                     0x2);
            for (let idx = 0x0; idx < attachedSegmentIDs.length;
                 idx++) {
              let _0x10d7bb = 0x0;
              ...
              lt_log("Turn\x20angle\x20to\x20outseg2\x20" +
                         attachedSegmentIDs[idx] + ":\x20" + _0x1bf6a7 +
                         "(" + _0x11d184 + "," + _0xff74b4 + ")",
                     0x2);
              ...
              if (Math.abs(_0x26651c - _0x1bf6a7) > MAX_PERP_DIF) {
                if (Math.abs(_0x26651c - _0x1bf6a7) > MAX_PERP_TO_CONSIDER)
                  continue;
                lt_log("\x20\x20\x20Not\x20eligible\x20as\x20outseg2:\x20" +
                           _0x1bf6a7,
                       0x2),
              ...
              if (_0x1859f0 !== null && _0x10d7bb >= _0x96949d) {
                if (_0x96949d === 0x0 && _0x10d7bb === 0x0) {
                        lt_log("Error:\x20>1\x20qualifying\x20exit2\x20segment\x20for\x20" + _0x2bb3f1.attributes.id +
                            ":\x20" + _0x1859f0.attributes.id + "," +
              ...
              (_0x1859f0 = _0x3e085f), (_0x4f9be7 = _0x1bf6a7),
                  (_0x96949d = _0x10d7bb);
            }
            if (_0x1859f0 == null) {
              ...
              lt_log("Found\x20outseg2\x20candidate:\x20" +
                         _0x1859f0.attributes.id + "\x20" +
                         (_0x96949d === 0x0 ? "" : "(failed)"),
                     0x2);
            for (let idx = 0x0; idx < segmentIDs.length;
                 idx++) {
              if (segmentIDs[idx] === _0x453456 ||
                  segmentIDs[idx] === _0x4777ff.attributes.id)
                continue;
              const _0x1b9808 = getSegObj(segmentIDs[idx]);
              let _0x3edc74 = 0x0;
              if ((_0x1b9808.attributes.fwdDirection &&
                   _0x1b9808.attributes.toNodeID !==
                       fromNodeObj.attributes.id) ||
                  (_0x1b9808.attributes.revDirection &&
                   _0x1b9808.attributes.fromNodeID !==
                       fromNodeObj.attributes.id))
                continue;
              let _0x46ff80 = _0x43a6d2(fromNodeObj.attributes.id, _0x1b9808),
                  _0x58b38d = _0xcd5d5b(_0x28857a, _0x46ff80);
              lt_log("Turn\x20angle\x20from\x20inseg\x20(supplementary)\x20" + segmentIDs[idx] + ":\x20" +
                         _0x58b38d + "(" + _0x28857a + "," + _0x46ff80 + ")",
                     0x3);
              ...
              if (_0x4fd61c !== null) {
                ...
                if (_0x5063e3 === 0x0 && _0x3edc74 === 0x0)
                  lt_log("Error:\x20>1\x20qualifying\x20segment\x20for\x20" + _0x2bb3f1.attributes.id +
                                     ":\x20" + _0x4fd61c.attributes.id + "," +
                                     _0x1b9808.attributes.id,
                                 0x2);
                          lt_log("==================================================================================", 0x2);
                  return HeuristicsCandidate.FAIL;
              }
              (_0x4fd61c = _0x1b9808); (_0x1c6b60 = _0x46ff80);
                  (_0x5063e3 = _0x3edc74);
            }
            if (_0x4fd61c == null) {
            ...
            if (_0x4e91d5 < 0x0 || _0x5063e3 < 0x0 || _0x96949d < 0x0) {
                lt_log("Found\x20a\x20failed\x20candidate\x20for\x20" + _0x453456 + "\x20(\x20" +
                    ...
                    ")",
                    0x2);
                return (_0x4e91d5 === HeuristicsCandidate.FAIL ||
                    _0x5063e3 === HeuristicsCandidate.FAIL ||
                    _0x96949d === HeuristicsCandidate.FAIL
                        ? HeuristicsCandidate.FAIL
                        : HeuristicsCandidate.ERROR);
            }
            lt_log("Found\x20a\x20heuristics\x20candidate!\x20" + _0x453456 + "\x20to\x20" +
                       _0x1859f0.attributes.id + "at" + _0x4f9be7,
                   0x2);
            return 0x1;
            function _0xca5734(_0x15149a, _0x25a1f9) {
              ...
              _0x25a1f9.attributes.fromNodeID === _0x15149a
                  ? ((_0x1fef83 = lt_get_second_point(_0x25a1f9).x -
                                  lt_get_first_point(_0x25a1f9).x),
                     (_0x3934e8 = lt_get_second_point(_0x25a1f9).y -
                                  lt_get_first_point(_0x25a1f9).y))
                  : ((_0x1fef83 = lt_get_next_to_last_point(_0x25a1f9).x -
                                  lt_get_last_point(_0x25a1f9).x),
                     (_0x3934e8 = lt_get_next_to_last_point(_0x25a1f9).y -
                                  lt_get_last_point(_0x25a1f9).y));
              let _0x21c597 = Math.atan2(_0x3934e8, _0x1fef83),
                  _0x232509 = ((_0x21c597 * 0xb4) / Math.PI) % 360;
              return (lt_log("Azm\x20from\x20node\x20" + _0x15149a +
                                 "\x20/\x20" + _0x25a1f9.attributes.id +
                                 ":\x20" + _0x232509,
                             0x3),
                      _0x232509);
            }
            function _0x43a6d2(_0x293709, _0x3901cd) {
              ...
              return (_0x228ce5 >= 0xb4 && (_0x228ce5 -= 360),
                      lt_log("Azm\x20to\x20node\x20" + _0x293709 + "/\x20" +
                                 _0x3901cd.attributes.id + ":\x20" + _0x228ce5,
                             0x3),
                      _0x228ce5);
            }
            function _0xcd5d5b(_0x362a09, _0xd93a20) {
              ...
              return ((_0x1eb39a +=
                       _0x1eb39a > 0xb4 ? -360 : _0x1eb39a < -0xb4 ? 360 : 0x0),
                      lt_log("Turn\x20" + _0x240602 + "," + _0x56fa6c +
                                 ":\x20" + _0x1eb39a,
                             0x3),
                      _0x1eb39a);
            }
            function _0x493643(_0x17bc7b, _0x31445a, _0x85690c) {
              lt_log(getString(0x338) + _0x17bc7b.attributes.id +
                         getString(0x365) + _0x85690c.attributes.id +
                         "\x20via\x20" + _0x31445a.attributes.id +
                         getString(0x1e8) +
                         _0x31445a[getString(0x39c)](_0x17bc7b, _0x85690c) +
                         getString(0x324) +
                         _0x17bc7b[getString(0x369)](_0x85690c, _0x31445a),
                     0x3);
              if (!_0x31445a.isTurnAllowedBySegDirections(_0x17bc7b,
                                                          _0x85690c)) {
          ...
          function lt_segment_length(segment) {
            let segmentLength =
                segment.geometry.getGeodesicLength(W.map.olMap.projection);
            lt_log("segment:" + segment.attributes.id + "computed\x20len:\x20" +
                       segmentLength + "attrs\x20len:\x20" +
                       segment.attributes.length,
                   0x3);
            return segmentLength;
          }
          function lt_log(devMsg, debugLevel = 0x1) {
            return debugLevel <= LANETOOLS_DEBUG_LEVEL &&
                   console.log("LaneTools Dev Msg: ", devMsg);
          }
          ...
          function copyLaneInfo(nodeName) {
            ...
            const selectedFeatures = W.selectionManager.getSelectedFeatures(),
                  ...
                  nodeID = nodeName === "A" ? featureAttributes.fromNodeID
                                            : featureAttributes.toNodeID,
                  laneCount = nodeName === "A" ? featureAttributes.revLaneCount
                                            : featureAttributes.fwdLaneCount;
            console.log(laneCount);
            const nodeObj = getNodeObj(nodeID),
                  attachedSegmentIDs = nodeObj.getSegmentIds(),
                  turnGraph = W.model.getTurnGraph();
            let _0x21c177;
            nodeName === "A" ? (_0x21c177 = featureGeometryComponents[0x1])
                             : (_0x21c177 = featureGeometryComponents
                                    [featureGeometryComponents.length - 0x2]);
            let _0x17c96f = _0x21c177.x - nodeObj.geometry.x,
                _0x3b764f = _0x21c177.y - nodeObj.geometry.y,
                _0x25f24a = Math.atan2(_0x3b764f, _0x17c96f),
                _0x1b508f = ((_0x25f24a * 0xb4) / Math.PI) % 360;
            for (let segIdx = 0x0; segIdx < attachedSegmentIDs.length;
                 segIdx++) {
              const segmentObject = getSegObj(attachedSegmentIDs[segIdx]);
              let _0x56f831 = segmentObject.getFeatureAttributes(),
                  geometryComponents = segmentObject.geometry.components, _0x165d3c,
                  selectedNodeName,
                  turnData =
                      turnGraph
                          .getTurnThroughNode(nodeObj, featureObject, segmentObject)
                          .getTurnData();
              if (turnData.state === 0x1 && turnData.lanes) {
                _0x56f831.fromNodeID === nodeID ? (selectedNodeName = "A")
                                                : (selectedNodeName = "B");
                selectedNodeName === "A"
                    ? (_0x165d3c = geometryComponents[0x1])
                ...
                (_turnData.id = segmentObject.attributes.id),
                    ...
                    (_turnData.lanes = _0x2ca8fc), _turnInfo.push(_turnData);
              }
              _turnInfo["sort"](
                  (_0x1252aa, _0x286486) =>
                      (_0x1252aa.order > _0x286486.order ? 0x1 : -0x1));
            }
          ...
          function pasteLaneInfo(_0x448ddd) {
            ...
            const selectedFeatures = W.selectionManager.getSelectedFeatures(),
                  featureObject =
                      selectedFeatures[0x0].attributes.wazeFeature._wmeObject,
                  components = featureObject.geometry.components,
                  featureAttributes = featureObject.getFeatureAttributes(),
                  _0xdafc0a = _0x448ddd === "A" ? featureAttributes.fromNodeID
                                                : featureAttributes.toNodeID;
            let _0x1989c7;
            const _0x32336a = getNodeObj(_0xdafc0a),
                  segmentIDs = _0x32336a["getSegmentIds"](),
                  turnGraph = W.model["getTurnGraph"]();
            let _0x44e9fd = {}, _0x1b740b = [];
            _0x448ddd === "A"
                ? (_0x1989c7 = components[0x1])
                : (_0x1989c7 = components[components.length - 0x2]);
            let _0x2362eb = _0x1989c7.x - _0x32336a.geometry.x,
                ...
                _0xf2c260 = ((_0x33018e * 0xb4) / Math.PI) % 360;
            for (let idx = 0x0; idx < segmentIDs.length; idx++) {
              let _0x3831b2 = getSegObj(segmentIDs[idx]),
                  _0x5842af = _0x3831b2.attributes,
                  _0x3619b7 = _0x3831b2.geometry.components, _0x3374c6 = {},
                  _0x52b37f,
                  turnData = turnGraph
                                 .getTurnThroughNode(_0x32336a, featureObject,
                                                     _0x3831b2)
                                 .getTurnData();
              _0x5842af.fromNodeID === _0xdafc0a ? (_0x52b37f = "A")
                                                 : (_0x52b37f = "B");
              _0x52b37f === "A"
                  ? (_0x3374c6 = _0x3619b7[0x1])
                  : (_0x3374c6 = _0x3619b7[_0x3619b7.length - 0x2]);
              if (turnData.state === 0x1) {
                (_0x44e9fd = {}),
                ...
                (_0x44e9fd.id = _0x5842af.id), (_0x44e9fd.order = _0x528fbb),
                    _0x1b740b.push(_0x44e9fd);
              }
              _0x1b740b.sort(
                  (_0x42b904, _0xb23157) =>
                      (_0x42b904.order > _0xb23157.order ? 0x1 : -0x1));
            }
            console.log(_0x1b740b);
            if (_turnInfo.length === _0x1b740b.length) {
              _0x448ddd === "A"
                  ? mAction.doSubAction(new UpdateObj(
                        featureObject, {revLaneCount : laneCount}))
                  : mAction.doSubAction(new UpdateObj(
                        featureObject, {fwdLaneCount : laneCount}));
              for (let _0x392af3 = 0x0; _0x392af3 < _0x1b740b.length;
                   _0x392af3++) {
                let _0x1662da = {};
                for (let _0x1f1e9b = 0x0; _0x1f1e9b < _turnInfo.length;
                     _0x1f1e9b++) {
                  _0x1662da[_0x1f1e9b] = _turnInfo[_0x1f1e9b];
                }
                let _0x1d44a8 = getSegObj(_0x1b740b[_0x392af3].id),
                    _0x4e30d7 = turnGraph.getTurnThroughNode(
                        _0x32336a, featureObject, _0x1d44a8),
              ...
              (mAction._description = "Pasted\x20some\x20lane\x20stuff"),
                  W.model.actionManager.add(mAction), $(".lanes-tab").click();
            } else
          ...
          function displayLaneGraphics() {
            ...
            if (!getId("lt-ScriptEnabled").checked ||
                !getId("lt-IconsEnable").checked || features.length !== 0x1 ||
                features[0x0].attributes.wazeFeature._wmeObject.type !==
                    "segment")
              return;
            const wmeObject = features[0x0].attributes.wazeFeature._wmeObject,
                  currentZoomLevel = W.map.getOLMap().getZoom();
            if ((wmeObject.attributes[getString(0x42f)] !==
                     (0x3 || 0x6 || 0x7) &&
                 currentZoomLevel < 0x10) ||
                currentZoomLevel < 0xf)
              return;
            let _0x2d2a03 =
                    wmeObject.attributes.fwdLaneCount > 0x0
                        ? _0x5694f9($(".fwd-lanes")
                                        .find(".lane-arrow")
                        ...
                        : false,
                _0x154122 =
                    wmeObject.attributes.revLaneCount > 0x0
                        ? _0x5694f9($(".rev-lanes")
                                        .find(".lane-arrow")
                                        .map(function() { return this; })
                                        .get())
            ...
            _0x2d2a03 && _0x19644c(W.model.nodes.getObjectById(
                                   ...
                                   _0x5dea5f);
            _0x154122 && _0x19644c(W.model.nodes.getObjectById(
                                       wmeObject.attributes.fromNodeID),
                                   _0x326722);
            function _0x19644c(nodeObj, _0x533989) {
                    ...
                    if (_0x23f39e === 0x1)
                      temp = {
                        ...
                        y : nodeObj.geometry.y +
                                (_0x55da4e.boxincwidth * _0x5095aa) / 1.8,
                      };
                    else {
                      if (_0x23f39e === 0x2)
                        temp = {
                          x : nodeObj.geometry.x -
                                  (_0x55da4e.start +
                                   _0x55da4e.boxincwidth * _0x5095aa),
                          y : nodeObj.geometry.y +
                                  (_0x55da4e.start + _0x55da4e.boxheight),
                        };
                      else {
                        if (_0x23f39e === 0x3)
                          temp = {
                            x : nodeObj.geometry.x +
                                    (_0x55da4e.start + _0x55da4e.boxincwidth),
                            y : nodeObj.geometry.y -
                                    (_0x55da4e.start + _0x55da4e.boxheight),
                          };
                        else {
              ...
              (_0x1d852d = _0x548ba5[getString(0x214)]()),
                  _0x548ba5[getString(0x2cc)](_0x2fcc96, _0x1d852d);
              let _0x79291a =
                  new OpenLayers.Feature.Vector(_0x548ba5, null, _0x5b7230);
              LTLaneGraphics.addFeatures([ _0x79291a ]);
              let _0xe41aaa = 0x0;
              _.each(_0x533989, (_0x25119b) => {
                let _0x4731ea = [];
                var _0x1bd240 = new OpenLayers.Geometry.Point(
                        _0x2a17ea.x + _0x55da4e.boxincwidth * _0xe41aaa +
                ...
                let _0x5f23a1 =
                    new OpenLayers.Feature.Vector(_0x30718d, null, _0x2c762f);
                LTLaneGraphics.addFeatures([ _0x5f23a1 ]);
                let _0x305721 = _0x30718d.getCentroid(),
                    _0x5001ff =
                        new OpenLayers.Geometry.Point(_0x305721.x, _0x305721.y),
                    wazeFont = "", _0x4e547b = {x : 0x0, y : 0x0},
                    _0x43b459 = {x : 0x0, y : 0x0};
                _0x25119b["uturn"] === true &&
                    ((wazeFont = constantStrings.wazeFontLink),
                     (_0x4e547b.x = 0.6), (_0x4e547b.y = 0.6),
                     (_0x43b459.x = -0x7), (_0x43b459.y = -0xc));
                _0x25119b["miniuturn"] === true &&
                    ((wazeFont = constantStrings.wazeFontLink),
                     (_0x4e547b.x = 0.3), (_0x4e547b.y = 0.25),
                     (_0x43b459.x = -0x8), (_0x43b459.y = 0x4));
                let _0x140285 = {
                  ...
                  backgroundYOffset : _0x43b459.y,
                    ...
                    _0x3f212b = new OpenLayers.Feature.Vector(_0x5001ff, null,
                                                              _0x140285);
          ...
          while (true) {
            try {
              const exitCode = -parseInt("116729CFFamr") / 0x1 +
                               ...
                               (parseInt("695094iWfXcp") / 0x6) *
                                   (-parseInt("7CccpnK") / 0x7) +
                               (parseInt("155432OeGIQS") / 0x8) *
                                   (-parseInt("396CKTurr") / 0x9) +
