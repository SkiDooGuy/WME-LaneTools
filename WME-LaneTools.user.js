...
const LI_UPDATE_NOTES = `FIXED:  Lane highlighting and turn icon display.<br>
KNOWN ISSUE:  Some tab UI enhancements may not work as expected.<br>
KNOWN ISSUE:  Highlighting hasn't worked right since far lanes.`;
